...
``` r
# I compared the variables side by side, they look exactly the same in each column, no issues noted
```
...
-   What does it mean if a z-score is positive or negative?
    ...
    -   positive: the raw score is higher than the mean average
    -   negative: the raw score is lower than the mean average
